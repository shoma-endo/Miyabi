...
export class CICDIntegration {
     ...
     */
    async listWorkflowRuns(limit = 10) {
        try {
     ...
     * Create a deployment
     */
    async createDeployment(ref, environment, description) {
        try {
     ...
     */
    async updateDeploymentStatus(deploymentId, state, targetUrl, description) {
        try {
     ...
     * List deployments
     */
    async listDeployments(environment, limit = 10) {
        try {
     ...
     */
    async waitForWorkflowCompletion(runId, timeoutMs = 300000) {
     ...
     */
    async getLatestSuccessfulDeployment(environment) {
        try {
