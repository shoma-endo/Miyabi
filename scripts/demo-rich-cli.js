...
import { logger, theme, 
// Phase 2 imports
createAgentStatusTable, createKPITable, successBox, warningBox, agentBox, resultSummaryBox, MultiStepProgress, renderTaskTree, } from '../agents/ui/index.js';
...
async function main() {
    ...
    logger.box(`🤖 CoordinatorAgent v1.0.0\nTask: Analyze Issue #123\nStatus: In Progress`, {
        title: 'Agent Status',
        borderStyle: 'round',
        padding: 1,
    });
    logger.newline();
    logger.box(`Total Cost: $245.50 / $500.00\nConsumption Rate: 49.1%\nStatus: ✅ Healthy`, {
...
//# sourceMappingURL=demo-rich-cli.js.map