...
export class DemoGenerator {
    ...
    screenshotsDir = path.join(this.assetsDir, 'screenshots');
    gifsDir = path.join(this.assetsDir, 'gifs');
    constructor() {
...
//# sourceMappingURL=generate-demo.js.map