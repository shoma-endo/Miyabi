...
export async function getGitHubToken() {
    ...
    throw new Error('GitHub token not found. Please authenticate using one of these methods:\n' +
...
export function getGitHubTokenSync() {
    ...
    // No valid token found
    throw new Error('GitHub token not found. Please authenticate using:\n' +
...
//# sourceMappingURL=github-token-helper.js.map