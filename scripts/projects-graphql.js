 ...
 */
export async function getProjectInfo(owner, projectNumber, token) {
  ...
  `;
    const result = await graphqlWithAuth(query, { owner, number: projectNumber });
    return {
 ...
 */
export async function addItemToProject(projectId, contentId, token) {
    const graphqlWithAuth = graphql.defaults({
        headers: { authorization: `token ${token}` },
    });
    const mutation = `
 ...
 */
export async function updateProjectField(projectId, itemId, fieldId, value, token) {
    const graphqlWithAuth = graphql.defaults({
        headers: { authorization: `token ${token}` },
    });
 ...
 */
export async function updateSingleSelectField(projectId, itemId, fieldId, optionId, token) {
    const graphqlWithAuth = graphql.defaults({
        headers: { authorization: `token ${token}` },
    });
    const mutation = `
 ...
 */
export async function getProjectItems(owner, projectNumber, token) {
    const graphqlWithAuth = graphql.defaults({
        headers: { authorization: `token ${token}` },
    });
    const query = `
 ...
 */
export async function generateWeeklyReport(owner, projectNumber, token) {
