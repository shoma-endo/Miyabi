...
// Singleton Instance
// ============================================================================
let asyncFileWriterInstance = null;
/**
 * Get singleton instance of AsyncFileWriter
 */
export function getAsyncFileWriter() {
 ...
 */
export async function appendFileAsync(filePath, content) {
    const writer = getAsyncFileWriter();
...
//# sourceMappingURL=async-file-writer.js.map